...
#link("https://helpx.adobe.com/camera-raw/digital-negative.html")[DNG] is the universal RAW file format. Converting to DNG should not lose any information, other than perhaps some producer-specific metadata. DNG does not compress, though it seems to be on average around 8% smaller than a non-compressed CR3 file in my testing with 127 files, CR3 converted to DNG through Adobe Lightroom. 
